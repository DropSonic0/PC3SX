...
void CALLBACK GPU__visualVibration(uint32_t iSmall, uint32_t iBig);
...
void CALLBACK CDR__readCDDA(unsigned char m, unsigned char s, unsigned char f, unsigned char *buffer);
...
long CALLBACK PAD1__keypressed(void);
